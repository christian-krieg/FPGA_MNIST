...
int conv2d_float(const float* data_in,
                 int          batch,
                 int          in_h,
                 int          in_w,
                 int          in_ch,
                 ...
                 int*         out_w,
                 int*         out_ch);
int conv2d_double(const double* data_in,
                  int           batch,
                  int           in_h,
                  int           in_w,
                  int           in_ch,
                  ...
                  int*          out_w,
                  int*          out_ch);
int conv2d_int8_t(const int8_t* data_in,
                  int           batch,
                  int           in_h,
                  int           in_w,
                  int           in_ch,
                  ...
                  int*          out_w,
                  int*          out_ch);
int conv2d_int16_t(const int16_t* data_in,
                   int            batch,
                   int            in_h,
                   int            in_w,
                   int            in_ch,
                   ...
                   int*           out_w,
                   int*           out_ch);
int conv2d_int32_t(const int32_t* data_in,
                   int            batch,
                   int            in_h,
                   int            in_w,
                   int            in_ch,
                   ...
                   int*           out_w,
                   int*           out_ch);
int conv2d_int64_t(const int64_t* data_in,
                   int            batch,
                   int            in_h,
                   int            in_w,
                   int            in_ch,
                   ...
                   int*           out_w,
                   int*           out_ch);
int conv2d_uint8_t(const uint8_t* data_in,
                   int            batch,
                   int            in_h,
                   int            in_w,
                   int            in_ch,
                   ...
                   int*           out_w,
                   int*           out_ch);
int conv2d_uint16_t(const uint16_t* data_in,
                    int             batch,
                    int             in_h,
                    int             in_w,
                    int             in_ch,
                    ...
                    int*            out_w,
                    int*            out_ch);
int conv2d_uint32_t(const uint32_t* data_in,
                    int             batch,
                    int             in_h,
                    int             in_w,
                    int             in_ch,
                    ...
                    int*            out_w,
                    int*            out_ch);
int conv2d_uint64_t(const uint64_t* data_in,
                    int             batch,
                    int             in_h,
                    int             in_w,
                    int             in_ch,
...
int conv2d_3x3_shift(const uint8_t*  data_in,
                     const int batch,
                     const int in_h,
                     const int in_w,
                     const int in_ch,
                     const uint8_t* kernel_shift,
                     const int fh,
                     const int fw,
                     const int kin_ch,
                     const int kout_ch,
                     const uint8_t* kernel_sign,
                     const int        fh_s,
                     const int        fw_s,
                     const int        kin_ch_s,
                     const int        kout_ch_s,
