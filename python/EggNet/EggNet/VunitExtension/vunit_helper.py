...
def generate_tests(obj, signs, data_widths):
    ...
    for sign, data_width in itertools.product(signs, data_widths):
        ...
        ) # NO function make_post_check !!! Review by Benni required

def init_eggnet(WEIGHT) : # Wrong Syntax !!!  Review by Benni required
    egg.FpiLeNet
    return egg.FpiLeNet.init_npz(npz_path=WEIGHT)
